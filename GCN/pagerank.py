...
# Create a feature matrix where each node's feature is its raw PageRank
...
for node_id, rank in pagerank_scores.items():
    ...
    pagerank_features[mapped_idx] = pagerank_values[node_mapping[node_id]]  # Assign raw PageRank

pyg_data.x = pagerank_features  # Assign PageRank as features
print(f"Assigned raw PageRank features: {pyg_data.x.shape}")
