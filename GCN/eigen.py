...
# Step 1: Compute Eigenvector Centrality
...
# Create a feature matrix where each node's feature is its raw eigenvector centrality
...
for node_id, centrality in eigenvector_centralities.items():
    ...
    centrality_features[mapped_idx] = centrality_values[node_mapping[node_id]]  # Assign raw centrality

pyg_data.x = centrality_features  # Assign eigenvector centrality as features
print(f"Assigned raw eigenvector centrality features: {pyg_data.x.shape}")
